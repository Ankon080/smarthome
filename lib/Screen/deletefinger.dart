...
import 'package:smarthome/Screen/deletefingerstatus.dart';
...
class deletefinger extends StatefulWidget {
  const deletefinger({super.key});

  @override
  State<deletefinger> createState() => _deletefingerState();
}

class _deletefingerState extends State<deletefinger> {
  ...
  void enrollFingerprint() async {
    try {
      ...
      if (id != null && id > 0 && id <= 127) {
        ...
        await _dbRef.child("Enroll_fingerprint").set(3);
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => DeleteFingerStatus()),
              (route) => false,
        );
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          filled: true,
                          fillColor: _isDarkMode ? Color.fromRGBO(96, 96, 96, 40) : Color.fromRGBO(220, 220, 220, 1),
                          hintText: "ID",
                          hintStyle: TextStyle(
                            color: _isDarkMode ? Colors.white54 : Colors.black54,
                          ),
